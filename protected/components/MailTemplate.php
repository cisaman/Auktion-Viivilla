<html>
    <head>
        ...
        <style type='text/css'>
            ...
            .header {font-size:10px; padding:0px; width:550px;background-color:blue;}
    ...
    <body>
        <div class='holder'>
            <div class='header'>
                <img src='{$path}images/custom_images/user/logo.png' alt='logo' />
            </div>
            <div class='content'>
                <div class='content-line'>Hi <strong>{$user_name},</strong></div>
                <div class='content-line'>Verification of your mail please <a href='{$href}'>Click Here</a></div>
            </div>
        </div>
        <div class='disclaimer'>
            <div class='disclaimer1'>theNewEdu.co</div>
        </div>
    </body>
</html>