...
class Template extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('template_created', 'default', 'value' => date("Y-m-d H:i:s")),
            array('template_id, template_alias, template_title, template_subject, template_content, template_parameters, template_created, template_updated, template_status', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('template_updated', $this->template_updated, true);
