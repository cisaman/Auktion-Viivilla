<div id="maincontent">
    <?php $this->pageTitle = Yii::app()->name . ' | ' . Yii::t('lang', 'bidding_history') . ' - All Auctions'; ?>

    <div class="row">
        <div class="col-lg-12">
            <div class="page-title">            
                <ol class="breadcrumb">
                    <li><h1><i class="fa fa-user"></i> <?php echo Yii::t('lang', 'bidding_history'); ?> - All Auctions</h1></li>
                </ol>
            </div>
        </div>    
    </div>
                                                                ...
                                                                foreach ($winners as $winner) {
                                                                    if ($winner->winner_userid == $objPaid) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center">
                                                                                <a class="btn btn-xs btn-green myStatusButton" title="Winner Payment Status" href="javascript:void(0);">
                                                                ...
                                                                foreach ($winners as $winner) {
                                                                    if ($winner->winner_userid == $objPaid) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center"><?php echo ($winner->winner_price + $product['p_shipping_price']); ?></td>
                                                                            <td align="center">
                                                                                <a class="btn btn-xs btn-orange myStatusButton" title="Winner Payment Status" href="javascript:void(0);">
                                                                                    <i class="fa fa-clock-o"></i> Pending
                                                                                </a>
                                                                            </td>
                                                                            <td align="center">
                                                                                <?php
                                                                                $email_id = Buyers::model()->findByPk($objPaid)->buyers_email;
                                                                                $item_url = Yii::app()->createAbsoluteUrl('auktion/' . $product['p_id'] . '/' . $product['p_slug']);
                                                                                $data_info = 'u_name=' . Buyers::model()->getUsername($objPaid) . '&u_email=' . $email_id . '&p_id=' . $product['p_id'] . '&p_name=' . $product['p_name'] . '&p_url=' . $item_url . '&u_status=' . Utils::getWinnerStatus($winner->winner_number) . '&amt=' . $winner->winner_price;
                                                                                ?>
...
<script type="text/javascript" async>
    $(document).ready(function () {
        $("#limitdata").change(function () {
            var link = 'allauctions?by=Payment';
            var limit = $(this).val();
