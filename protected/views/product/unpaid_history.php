<div id="maincontent">
    <?php $this->pageTitle = Yii::app()->name . ' | ' . Yii::t('lang', 'bidding_history') . ' - Unpaid Auctions'; ?>

    <div class="row">
        <div class="col-lg-12">
            <div class="page-title">            
                <ol class="breadcrumb">
                    <li><h1><i class="fa fa-user"></i> <?php echo Yii::t('lang', 'bidding_history'); ?> - Unpaid Auctions</h1></li>
                </ol>
            </div>
        </div>    
    </div>
                                                                    ...
                                                                    if ($winner->winner_userid == $objPaid) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center">
                                                                                ...
                                                                                $data_info = 'u_name=' . Buyers::model()->getUsername($objPaid) . '&u_email=' . $email_id . '&p_id=' . $product['p_id'] . '&p_url=' . $item_url . '&u_status=' . Utils::getWinnerStatus($winner->winner_number) . '&amt=' . $winner->winner_price;
                                                                                ?>
...
<script type="text/javascript" async>
    $(document).ready(function () {
        $("#limitdata").change(function () {
            var link = 'unpaidauctions?by=Payment';
            var limit = $(this).val();
