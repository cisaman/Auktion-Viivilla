<div id="maincontent">
    <?php $this->pageTitle = Yii::app()->name . ' | ' . Yii::t('lang', 'bidding_history') . ' - Paid Auctions'; ?>

    <div class="row">
        <div class="col-lg-12">
            <div class="page-title">            
                <ol class="breadcrumb">
                    <li><h1><i class="fa fa-user"></i> <?php echo Yii::t('lang', 'bidding_history'); ?> - Paid Auctions</h1></li>
                </ol>
            </div>
        </div>    
    </div>
                            ...
                            <div class="table-responsive">
                                ...
                                if (count($result) > 0) {
                                    ...
                                    foreach ($result as $product) {
                                        $paid = $product['paid'];
                                        $winners = $product['winners']->result;
                                            ...
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="col-sm-7" style="padding-left: 0px;">
                                                        <div style="overflow: hidden; height: 100%; border: 1px solid rgb(204, 204, 204);">
                                                            ...
                                                            <div style="height: 146px; width: 100%; overflow-x: hidden; overflow-y: scroll;">
                                                                <?php $bids = Bid::model()->AdminGetBids($product['p_id']); ?>
                                                                <?php if ($bids > 0) { ?>
                                                                    <?php $j = 1; ?>
                                                ...
                                                <?php if (count($paid) > 0) { ?>
                                                    <div class="row" style="max-height: 250px; overflow: auto; border: 1px solid rgb(204, 204, 204); margin: 0px 0px 10px;">
                                                        ...
                                                        <table class="table table-responsive table-bordered table-striped statusTable" style="margin: 0px ! important; font-size: 12px;">
                                                            <tr>
                                                                <th>#</th>
                                                                <th>User ID</th>
                                                                <th>User Name</th>
                                                            ...
                                                            <?php $count = 1; ?>
                                                            <?php foreach ($paid as $objPaid) { ?>
                                                                <?php
                                                                foreach ($winners as $winner) {
                                                                    if ($winner->winner_userid == $objPaid) {
                                                                        ?>
                                                                        <tr>
                                                                            <td align="center"><?php echo $count++; ?></td>
                                                                            <td align="center"><?php echo $objPaid; ?></td>
                                                                            <td align="center"><?php echo Buyers::model()->getUsername($objPaid); ?></td>
                                                                            <td align="center"><?php echo Utils::getWinnerStatus($winner->winner_number); ?></td>
                                                                            <td align="center"><?php echo $winner->winner_price; ?></td>
                                                                            <td align="center"><?php echo $product['p_shipping_price']; ?></td>
                                                                            <td align="center"><?php echo ($winner->winner_price + $product['p_shipping_price']); ?></td>
                                                                            <td align="center">
                                                                                <a class="btn btn-xs btn-green myStatusButton fullwidth" title="Winner Payment Status" href="javascript:void(0);">
                                                                                    <i class="fa fa-check"></i> Completed
                                                                                </a>
                                                                            </td>
                                                                            <td align="center">
                                                                                <?php
                                                                                $payment = Payment::model()->findByAttributes(array('payment_productID' => $product['p_id'], 'payment_buyersID' => $objPaid));
                                                                                //print_r($payment);
                                                                                if ($payment->payment_orderstatus == 1) {
                                                                                    echo '<label class="btn btn-xs btn-green myStatusButton fullwidth" title="Order Status"><i class="fa fa-check"></i> Completed</label>';
                                                                                } else {
                                                                                    echo '<a class="btn btn-xs btn-warning myStatusButton btnOrder fullwidth" title="Order Status" href="javascript:void(0);" data="order" data-id="' . $payment->payment_id . '"><i class="fa fa-clock-o"></i> Pending</a>';
                                                                                }
                                                                                ?>
                                                                            </td>
                                                                            <td align="center">
                                                                                <?php
                                                                                if ($payment->payment_orderstatus == 1) {
                                                                                    echo $payment->payment_orderdatetime;
                                                                                } else {
                                                                                    echo '-';
                                                                                }
                                                                                ?>
                                                                            ...
                                                                            <td align="center">
                                                                                <a class="" href="<?php echo Utils::GetBaseUrl() . '/buyers/view/' . $objPaid; ?>" target="_blank" title="View User">
                                                                                    <i class="fa fa-search"></i>
                                                                                </a>                                                                                    
                                                                            </td>
                                                                        </tr>
...
<style type="text/css">
    ...
    .fullwidth {width: 100%;}
    .btn {padding: 5px !important;font-size: 12px !important;margin-bottom:5px;}
...
<script type="text/javascript" async>
    $(document).ready(function () {
        $("#limitdata").change(function () {
            var link = 'paidauctions?by=Payment';
            var limit = $(this).val();
