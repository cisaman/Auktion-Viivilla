...
$this->pageTitle = Yii::app()->name . ' | ' . Yii::t('lang', 'add') . ' ' . Yii::t('lang', 'product');
?>
        ...
        <div class="portlet portlet-default">
            <div class="portlet-body">
                <ul id="userTab" class="nav nav-tabs">
                    <li class="active"><a href="#product-add" data-toggle="tab"><?php echo Yii::t('lang', 'add'); ?> <?php echo Yii::t('lang', 'product'); ?></a></li>
                </ul>
