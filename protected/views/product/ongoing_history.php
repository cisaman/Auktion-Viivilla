<div id="maincontent">
    <?php $this->pageTitle = Yii::app()->name . ' | ' . Yii::t('lang', 'bidding_history') . ' - Ongoing Auctions'; ?>

    <div class="row">
        <div class="col-lg-12">
            <div class="page-title">            
                <ol class="breadcrumb">
                    <li><h1><i class="fa fa-user"></i> <?php echo Yii::t('lang', 'bidding_history'); ?> - Ongoing Auctions</h1></li>
                </ol>
            </div>
        </div>    
    </div>
...
<style type="text/css">
    ...
    .datetimepicker.datetimepicker-dropdown-bottom-right.dropdown-menu {top:180.3px !important;}
</style>
...
<script type="text/javascript" async>
    $(document).ready(function () {
        $("#limitdata").change(function () {
            var link = 'ongoingauctions?by=Payment';
            var limit = $(this).val();
