...
$this->pageTitle = Yii::app()->name . ' | Manage Countries';
...
<div class="row">
    <div class="col-lg-12">
        <div class="page-title">            
            <ol class="breadcrumb">
                <li><h1><i class="fa fa-user"></i> Manage Countries</h1></li>
            </ol>
        </div>
    </div>    
</div>
        ...
        <div class="portlet portlet-default">
            <div class="portlet-body">
                ...
                <ul id="userTab" class="nav nav-tabs">
                    <li class="active"><a href="#country-list" data-toggle="tab">List of Countries</a></li>
                    <?php if ($super_role_id == 1) { ?>
                        <li class=""><a href="#country-add" data-toggle="tab">Add Country</a></li>
                    <?php } ?>
                </ul>
                                    ...
                                    $this->widget('zii.widgets.grid.CGridView', array(
                                        ...
                                        'columns' => array(
                                            ...
                                            array(
                                                ...
                                                'filter' => CHtml::activeTextField($model, 'country_name', array('placeholder' => 'Country Name', 'style' => 'font-style:italic', 'autocomplete' => 'off', 'class' => 'form-control'))
                                            ),
                                            array(
                                                'name' => 'country_status',
                                                'value' => '($data->country_status == 0) ? "Inactive" : "Active"',
                                                'htmlOptions' => array('style' => 'text-align:center;'),
                                                'headerHtmlOptions' => array('style' => 'text-align: center;width:150px'),
                                                'filter' => CHtml::activeDropDownList($model, 'country_status', array(0 => 'Inactive', 1 => 'Active'), array('style' => 'font-style:italic', 'class' => 'form-control', 'empty' => 'Please Select Status'))
                                            ),
                                            array(
                                                'header' => 'Action',
                                                'class' => 'CButtonColumn',
