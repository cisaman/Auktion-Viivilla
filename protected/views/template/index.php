...
<div class="row">
    <div class="col-lg-12">
        <div class="page-title">            
            <ol class="breadcrumb">
                <li><h1><i class="fa fa-user"></i> <?php echo Yii::t('lang', 'manage'); ?> <?php echo Yii::t('lang', 'templates'); ?></h1></li>
            </ol>
        </div>
    </div>    
</div>
        ...
        <div class="portlet portlet-default">
            <div class="portlet-body">
                ...
                <ul id="userTab" class="nav nav-tabs">
                    <li class="active"><a href="#template-list" data-toggle="tab"><?php echo Yii::t('lang', 'list_of'); ?> <?php echo Yii::t('lang', 'templates'); ?></a></li>
                    <li class=""><a href="#template-add" data-toggle="tab"><?php echo Yii::t('lang', 'add'); ?> <?php echo Yii::t('lang', 'template'); ?></a></li>
                </ul>
                                    ...
                                    $this->widget('zii.widgets.grid.CGridView', array(
                                        ...
                                        'columns' => array(
                                            ...
                                            array(
                                                ...
                                                //'value' => '($data->template_status == 0) ? Yii::t("lang", "inactive") : Yii::t("lang", "active")',
                                                'type' => 'raw',
                                                'value' => '($data->template_status == 0) ? "<a class=\"btn btn-xs btn-red\">" . Yii::t("lang", "inactive") . "</a>" : "<a class=\"btn btn-xs btn-green\">" . Yii::t("lang", "active")  . "</a>"',
                                                'htmlOptions' => array('style' => 'text-align:center;'),
                                                'headerHtmlOptions' => array('style' => 'text-align: center;width:150px'),
                                                'filter' => CHtml::activeDropDownList($model, 'template_status', array(0 => Yii::t('lang', 'inactive'), 1 => Yii::t('lang', 'active')), array('style' => 'font-style:italic', 'class' => 'form-control', 'empty' => Yii::t('lang', 'please_select') . ' ' . Yii::t('lang', 'status')))
                                            ),
                                            array(
