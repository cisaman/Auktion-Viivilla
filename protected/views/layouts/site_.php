...
<html>
    <head>
        ...
        <!-- FlipClock Css and Js -->
        <!--link rel="stylesheet" type="text/css" href="<?php echo Utils::GetBaseUrl(); ?>/bootstrap/site/flipclock/flipclock.css" /-->
        <!--script src="<?php echo Utils::GetBaseUrl(); ?>/bootstrap/site/flipclock/flipclock.js"></script-->
                            ...
                            <div class="center-head">
                                ...
                                <div class="form-group">
                                    <form action="/searchterm" method="get">
                                        ...
                                        <input class="form-control search-input ui-autocomplete-input" placeholder="Nyckelord + Enter" name="keyword" value="<?php echo @$_GET['keyword'] ?>" type="text" autocomplete="off"/>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 slider-part" style="margin: 30px 0px;">
                                <div class="row">
                                    <div class="slider-head">
                                        <h3 style="text-transform: none;"><?php echo Yii::t('lang', 'auctions_ending_soon'); ?></h3>
                                    </div>
...
<?php } ?>
        ...
        <noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-W9BD4L"
        ...
        <script async>(function (w, d, s, l, i) {
            ...
            })(window, document, 'script', 'dataLayer', 'GTM-W9BD4L');</script>
