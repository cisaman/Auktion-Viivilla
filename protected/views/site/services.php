            ...
            <div class="grid_12">
                <div class="isotope row">
                    <div class="element-item grid_4 c1">
                        <div class="box_7">
                            <div class="img-wrap">
                                <img src="<?php echo Yii::app()->request->baseUrl ?>/bootstrap/site/images/index-2_img01.jpg" alt="Image 1"/>
                            </div>
                            <div class="caption">
                    ...
                    <div class="element-item grid_4 c1">
                        <div class="box_7">
                            <div class="img-wrap">
                                <img src="<?php echo Yii::app()->request->baseUrl ?>/bootstrap/site/images/index-2_img02.jpg" alt="Image 2"/>
                            </div>
                            <div class="caption">
                    ...
                    <div class="element-item grid_4 c1">
                        <div class="box_7">
                            <div class="img-wrap">
                                <img src="<?php echo Yii::app()->request->baseUrl ?>/bootstrap/site/images/index-2_img03.jpg" alt="Image 3"/>
                            </div>
                            <div class="caption">
                    ...
                    <div class="element-item grid_4 c2">
                        <div class="box_7">
                            <div class="img-wrap">
                                <img src="<?php echo Yii::app()->request->baseUrl ?>/bootstrap/site/images/index-2_img04.jpg" alt="Image 4"/>
                            </div>
                            <div class="caption">
                    ...
                    <div class="element-item grid_4 c2">
                        <div class="box_7">
                            <div class="img-wrap">
                                <img src="<?php echo Yii::app()->request->baseUrl ?>/bootstrap/site/images/index-2_img05.jpg" alt="Image 5"/>
                            </div>
                            <div class="caption">
                                <h3 class="text_2 color_2"><a href="#">Tertomino verto</a></h3>
                                <p class="text_3">
                    ...
                    <div class="element-item grid_4 c3">
                        <div class="box_7">
                            <div class="img-wrap">
                                <img src="<?php echo Yii::app()->request->baseUrl ?>/bootstrap/site/images/index-2_img06.jpg" alt="Image 6"/>
                            </div>
                            <div class="caption">
