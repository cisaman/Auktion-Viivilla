<div id="maincontent">
    ...
    <?php
    $this->pageTitle = Yii::app()->name . ' | Alla auktioner';
                                                ...
                                                <div class="bid-left" style="width: 100%">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            ...
                                                            <?php if (isset($p['p_current_price']) && !empty($p['p_current_price'])) { ?>
                                                                ...
                                                                <span class="num price_<?php echo $p['p_id']; ?>" style="display:none;"><?php echo $p['p_current_price']; ?></span>
                                                            <?php } ?>
                                                                            ...
                                                                            if ($winner->winner_userid == $objPaid) {
                                                                                ...
                                                                                <div class="current-price" style="border: medium none; background: none repeat scroll 0% 0% transparent; padding: 0px;width: 100%">
                                                                                    <button class="log-in-box manage-btn color-paid" type="button" style="width: 100%; margin-top: 10px; padding: 8px 5px;">
                                                                                        Du har betalat <?php echo ($winner->winner_price + $p['p_shipping_price']); ?> Kr
                                                                                    </button>
                                                                                </div>
                                                                                <?php
                                                                            }
...
<script type="text/javascript">
    ...
    $('.order').click(function () {
        ...
        var link = '<?php echo Utils::GetBaseUrl(); ?>/site/allauctions?limit=' + limit + '&by=ajax';
        console.log(link);
