<div id="maincontent">
    ...
    <?php
    $this->pageTitle = Yii::app()->name . ' | Pågående auktioner';
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4">                                                        
                                                            ...
                                                            <div class="hideBoxWhenExpired_pid_r_<?php echo $p['p_id']; ?>">
                                                                <div class="bid-dollar" style="width: 100% ! important;">
...
<script type="text/javascript">
    ...
    $('.order').click(function () {
        ...
        var link = '<?php echo Utils::GetBaseUrl(); ?>/site/ongoingauctions?limit=' + limit + '&by=ajax';
        console.log(link);
