<?php
$this->pageTitle = Yii::app()->name . ' | ' . $history_type;
                                            ...
                                            <div class="bid-left" style="width: 100%">
                                                <div class="row">
                                                    <div class="col-sm-3 pid_each_<?php echo $p['p_id']; ?>">
                                                        <a href="<?php echo Yii::app()->createAbsoluteUrl('site/product/', array('id' => $p['p_id'], 'title' => $p['p_slug'])); ?>" style="width: 100%;">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="bid-info" style="margin: 0px;width:85%">
                                                            ...
                                                            <h4><a href="<?php echo Yii::app()->createAbsoluteUrl('site/product/', array('id' => $p['p_id'], 'title' => $p['p_slug'])); ?>" alt="<?php echo $p['p_name']; ?>"><?php echo $p['p_name']; ?></a></h4>
                                                        ...
                                                        switch ($history_id) {
                                                            case 1:
                                                                ...
                                                                <?php if (isset($p['p_price']) && !empty($p['p_price'])) { ?>
                                                                    <div class="side-log" id="highbidder_nickname_block_<?php echo $p['p_id']; ?>" style="display: none;">
                                                                    ...
                                                                    <!--div class="current-price" style="float: none;width: 100%;">
                                                                        <span><?php echo Yii::t('lang', 'current_price'); ?>:</span-->
                                                                    <span class="num" style="display: none;">
                                                                        <span class="price_<?php echo $p['p_id']; ?>" style="color: rgb(255, 255, 255);"><?php echo $p['p_price']; ?></span> Kr
                                                                    </span>
                                                                    <!--/div-->
                                                                <?php } ?> 

                                                                <div class="hideBoxWhenExpired_pid_r_<?php echo $p['p_id']; ?>">
                                                                    <div class="bid-dollar" style="float: none; width: 100% ! important;">
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control numeric nextprice_<?php echo $p['p_id']; ?>" placeholder="<?php echo $p['p_biddiff']; ?>" id="textBid<?php echo $p['p_id']; ?>">
                                                                            <span class="input-group-addon">Kr+</span>
                                                                        </div>
                                                                    </div>
                                                                    <button 
                                                                        type="button" 
                                                                        class="log-in-box manage-btn ongoing-btn" 
                                                                        id="btnBid<?php echo $p['p_id']; ?>" 
                                                                        pid="<?php echo $p['p_id']; ?>"
                                                                        pname="<?php echo $p['p_name']; ?>"
                                                                        uid="<?php echo $p['p_userid']; ?>" 
                                                                        sessionid="<?php echo $session_id; ?>"
                                                                        style="width: 100%;"
                                                                        >
                                                                            <?php echo Yii::t('lang', 'make_bid'); ?>
                                                                    </button>
                                                                </div>
                                                                <?php
                                                                break;
                                                            ...
                                                            case 3:
                                                                ...
                                                                <?php if (isset($p['p_paid']) && !empty($p['p_paid'])) { ?>
                                                                    <div class="current-price" style="border: medium none; background: none repeat scroll 0% 0% transparent; padding: 0px;width: 100%">
                                                                        <button class="log-in-box manage-btn color-paid" type="button" style="width: 100%; margin-top: 10px; padding: 8px 5px;">
                                                                            Du har betalat <?php echo (int) $p['p_paid']; ?> Kr
                                                                        </button>
                                                                    </div>
                                                                <?php } ?> 
                                                            ...
                                                            case 4:
                                                                ...
                                                                <?php if ($p['p_shipping_price']) { ?>
                                                                    <div class="current-price" style="margin-top: 5px;width: 100%;">
                                                                        <span><?php echo Yii::t('lang', 'shipping_price') ?>:</span>
                                                                        <span class="num"><?php echo $p['p_shipping_price']; ?> Kr</span>
                                                                    </div>                                            
                                                                <?php } ?>
                                                            ...
                                                            case 5:
                                                                ...
                                                                <?php if ($p['p_expiry'] > 0) { ?>
                                                                    ...
                                                                    <div class="bid-dollar" style="margin-top: 5px; width: 100% ! important;">
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control" placeholder="<?php echo $p['p_biddiff']; ?>" id="textBid<?php echo $p['p_id']; ?>">
                                                                            <span class="input-group-addon">Kr+</span>
                                                                        </div>                                                            
                                                                    </div>
